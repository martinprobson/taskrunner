 ...
 * for all the {@code TaskRunner} classes that require it.</p>
...
public class ConfigurationService {
    ...
    public static Configuration getConfiguration() {
        if (service == null)
            throw new java.util.ServiceConfigurationError("TaskRunner requires a global configuration to be set.");
