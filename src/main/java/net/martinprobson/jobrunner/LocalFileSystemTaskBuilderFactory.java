...
public interface LocalFileSystemTaskBuilderFactory {
     ...
     * @param taskDirectory The base directory on the file system from which Tasks will be loaded.
     * @param configDirectory The base directory on the file system from which Tasks will be loaded.
     * @return A {@code LocalFileSystemTaskBuilder}.
     */
    LocalFileSystemTaskBuilder create(@Assisted("taskDirectory") String taskDirectory,
