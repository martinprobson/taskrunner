...
public class JobRunnerConfigurationProviderTest {

    @Test
    public void getXmlConfig() {
        XMLConfiguration config =
                JobRunnerConfigurationProvider.getXmlConfig("configprovider_test_1.xml");
        assertEquals("foo", config.getString("test"));
    }

    @Test
    public void getConfigurationtest1() {
        JobRunnerConfigurationProvider provider =
                new JobRunnerConfigurationProvider("configprovider_test_1.xml");
    ...
    public void getConfigurationtest2() {
        JobRunnerConfigurationProvider provider =
                new JobRunnerConfigurationProvider("configprovider_test_1.xml", "configprovider_test_2.xml");
        Configuration config = provider.getConfiguration();
